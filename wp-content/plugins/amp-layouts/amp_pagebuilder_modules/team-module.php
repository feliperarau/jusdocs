...
$frontCommonCss = '';
 $output = '
          <div class="team-mod">
              {{if_team_header_type}}<{{team_header_type}}>{{team_tlt}}</{{team_header_type}}>{{ifend_team_header_type}}
              <div class="tm-blk">
                {{repeater}}
              </div>
          </div>
       ...
       array(
                ...
                'output_format'=>''
                  ...
                  array(    
                        ...
                        'default'  =>'Heading', 
                        'content_type'=>'html',
                        'required'  => array('check_for_content'=>'1','team_header_type'=> array('h1','h2','h3','h4','h5','h6'))
                      ),
                  array(
                      'type'    =>'text',
                      'name'    =>"hd_size",
