...
';
 $output = '{{if_condition_content_layout_type==1}}
             ...
             {{if_condition_check_for_content==1}}
                <div class="cntn-desc">
                {{if_persentation_header_type}}<{{persentation_header_type}}>{{heading}}</{{persentation_header_type}}>{{ifend_persentation_header_type}}
                  {{content_title}}
                  <div class="prsn-btn">
                    <a href="{{btn_lnk}}" {{if_condition_page_link_open==new_page}}target="_blank"{{ifend_condition_page_link_open_new_page}} >{{cntn_btn}}{{if_condition_check_for_icon==1}}<i class="ico-pic icon-{{icon-picker}}"></i>{{ifend_condition_check_for_icon_1}}</a>
                  </div>
                </div>
    ...
    'tabs' => array(
 		...
 		'fields' => array(
            ...
            array(    
              ...
              'default' =>'Heading', 
              'content_type'=>'html',
              'required'  => array('check_for_content'=>'1','persentation_header_type'=> array('h1','h2','h3','h4','h5','h6'))
            ),
            array(
                'type'    =>'spacing',
                'name'    =>"padding_gap",
