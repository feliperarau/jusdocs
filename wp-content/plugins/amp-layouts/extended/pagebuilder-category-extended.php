    ...
    if(isset($modules['contents']['fields'])){
        foreach ($modules['contents']['fields'] as $key => $value) {
            if($value['name']=='content_layout_type'){
                ...
                $modules['contents']['fields'][] = array(    
                    'type'    =>'text',
                    'name'    =>"cat-more-stories",
                    'label'   =>esc_html__("More Stories","accelerated-mobile-pages"),
                    'tab'     =>'customizer',
                      ...
                      {{if_condition_content_layout_type==5}}
                        ...
                        {{if_condition_content_layout_type==6}}
                         <div class="pb_mod cat-6">
                            ...
                            <div class="c6-b">
                                <a class="lk" href="{{content_category_link}}">{{cat-more-stories}}</a>
                            </div>
                ...
                $front_loop_content = '{{if_condition_content_layout_type==2}}
                    ...
                    <a href="{{ampforwp_post_url}}">
                        ...
                        <div class="cat-ovly">
                            <div class="cat-4-artl">
                                <div class="cat-4-pt">
                                    <span class="pst-dt">{{postdate}}</span><span class="by">{{ampbytext}}</span><span class="pst-by">{{authorname}}</span>
                                </div>
                                <h2>{{title}}</h2>
                            </div>
                        </div>
                  ...
                  {{if_condition_content_layout_type==5}}
                    <div class="dsg-5">
                        ...
                        <div class="athr-dtls">
                            <a href="{{ampforwp_post_url}}">
                                {{ampbytext}} <span class="athr-nm">{{authorname}}</span>
                  ...
                  {{if_condition_content_layout_type==6}}
                    <li>
                        <div class="dsg-6">
                            ...
                            <div class="c6-ad">
                                <a href="{{ampforwp_post_url}}">
                                    {{if_condition_tagcatselect==1}}{{if_tags}}<span class="tag">{{tags}}</span>{{ifend_tags}}{{ifend_condition_tagcatselect_1}}

                                    {{if_condition_tagcatselect==2}}{{if_category}}<span class="tag">{{category}}</span>{{ifend_category}}{{ifend_condition_tagcatselect_2}}

                                    <h4>{{title}}</h4>
                                    <div class="at-ds">
                                        {{ampbytext}} <span class="at-n">{{authorname}}</span>
                                    </div>
                                </a>
                            </div>
                        </div>
...
add_filter('ampforwp_pb_cntmod_rawhtml', 'update_category_content');
function update_category_content($rawhtml){
    $category = get_the_category();
    if(isset($category[0])){
        $category = $category[0]->name;
    }
     $rawhtml = str_replace(array('{{category}}'),array($category), $rawhtml);
     global $redux_builder_amp;
     $ampbytext = $redux_builder_amp['amp-translator-by-text'];
     $rawhtml = str_replace(array('{{ampbytext}}'), $ampbytext , $rawhtml);
