...
function ampforwp_layouts_config_extend($sections){
			...
			$headerdesign8 = array(
				        'alt'=>' Header Design 8 ',
				        'img' =>AMPFORWP_LAYOUT_DIR_URI.'/images/header-8.png'
				        );
			$getlink      = array(
			             'id'       => 'ampforwp-author-layout-link',
			             ...
			             'default'  => '0',
		             	 'required' => array(
		             	 	...
		             	 	array('ampforwp-author-page-url' , '=' , '1')),
		        		);
	            	...
	            	if(count($section_value['fields'])>0){
	            		foreach ($section_value['fields'] as $fieldkey => $field_value) {
	            			...
	            			if($field_value['id']=='single-design-type'){
	            				...
	            				array_splice($sections[$key]['fields'], 24, 0, array($getlink));
	            			...
	            			if($field_value['id']=='header-type'){
	            				...
	            				$sections[$key]['fields'][$fieldkey]['options'][8] = $headerdesign8;
	            			}
