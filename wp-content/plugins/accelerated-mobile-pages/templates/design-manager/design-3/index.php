        ...
        <div>
          <a href="<?php echo ampforwp_url_controller( get_the_permalink() ); ?>">
            <?php if ( ampforwp_has_post_thumbnail() ) {
						...
						if($thumb_url){
							?>
            <amp-img src=<?php echo esc_url($thumb_url) ?> width=<?php echo esc_attr($thumb_width); ?>
              height=<?php echo esc_attr($thumb_height); ?> layout="responsive"></amp-img>
            <?php }
					}?>
  ...
  <main>
    ...
    <div
      ...
      <div class="amp-wp-post-content">
        ...
        <h2 class="amp-wp-title"><a href="<?php echo ampforwp_url_controller( get_the_permalink() ); ?>">
            <?php the_title(); ?></a></h2>
