 ...
 * Class Woo_Products.
 */
class amp_uae_Woo_Products extends Common_Widget {
...
if ( $theme->name == 'Astra'  || class_exists( 'Astra_Ext_Advanced_Hooks_Markup' ) ) {
		add_action( 'amp_post_template_css',[$this,'amp_custom_css_carousel'],999);
		add_filter( 'ampforwp_the_content_last_filter',[$this,'ampforwp_carousel_builder_woo']);
		}	
	...
	public function amp_custom_css_carousel(){
		echo "@media (min-width:767px){.amp-carousel-slide.amp-scrollable-carousel-slide{margin:1px -55px 0 -7px;text-align:center}li.product.instock.sale.shipping-taxable.purchasable.product-type-simple.amp-carousel-slide.amp-scrollable-carousel-slide{width:285px;vertical-align:top}.uael-woo-product-wrapper{width:60%}.uael-woocommerce li.product{padding-right:calc(0px / 2);padding-left:calc(0px / 2);margin:0 0 0 -15px;padding:0}}
@media (max-width:767px){.elementor-column{width:62%}.uael-woo-slider-arrow-outside.uael-woo-slider-arrow-circle.elementor-widget.elementor-widget-uael-woo-products{width:65%}li.first.instock.sale.shipping-taxable{width:333px;margin-left:-23px}.woocommerce ul.products li.product a amp-img{width:70%}.woocommerce ul.products[class*=columns-] li.product,.woocommerce-page ul.products[class*=columns-] li.product{width:50%;left:-6%}.woocommerce ul.products[class*=columns-] li.product:nth-child(2n),.woocommerce-page ul.products[class*=columns-] li.product:nth-child(2n){float:none;clear:none}.woocommerce ul.products li.product .onsale{margin:-.5em 7.5em 0 0}.woocommerce ul.products li.product,.woocommerce-page ul.products li.product{margin:0 11px 0 5px}li.product.instock.sale.shipping-taxable.purchasable.product-type-simple.amp-carousel-slide.amp-scrollable-carousel-slide{width:285px;vertical-align:top}.uael-sale-flash-circle.uael-featured-flash-circle.elementor-widget.elementor-widget-uael-woo-products{width:70%}.uael-woo-product-wrapper{width:90%}li.product.first.instock.shipping-taxable.purchasable.product-type-variable.has-default-attributes{position:relative;left:-34px}.astra-shop-summary-wrap{left:15%;position:relative}}";
	}

	public function ampforwp_carousel_builder_woo($cb){
    //$completeContent = preg_replace('/"slidesToShow":4/', '"slidesToShow":5'  , $completeContent);
$cb = preg_replace('/data-woo_slider=\'{"slidesToShow":(.*?),/', 'data-woo_sliderr=\'{"slidesToShow":$1,'  , $cb);
$cb = preg_replace('/data-woo_sliderr=\'{"slidesToShow":1,/', 'data-woo_slider=\'{"slidesToShow":1,'  , $cb);
$cb = preg_replace('/<div\s+data-woo_sliderr=\'{"slidesToShow":(.*?),(.*?)><div\s+class="uael-slick-dotted(.*?)>/', '<div data-woo_sliderr=\'{"slidesToShow":$1,$2><div class="carousel-big-uael-slick-dotted$3>'  , $cb);

$cb = preg_replace('/<div class="carousel-big-(.*?)"><ul class="products columns-(.*?)">(.*?)<\/ul>/s', '<div class="carousel-big-$1"><amp-carousel id="carousel-with-lightbox" height="400" layout="fixed-height" type="carousel">$3</amp-carousel>'  , $cb);
//$cb = preg_replace('/<head>/', '<head><script async custom-element="amp-carousel" src="https://cdn.ampproject.org/v0/amp-carousel-0.1.js"></script>'  , $cb);
$cb = preg_replace('/class="woocommerce-Price-amount amount"/', 'class="woocommerce-Price-amounter amount"'  , $cb);
