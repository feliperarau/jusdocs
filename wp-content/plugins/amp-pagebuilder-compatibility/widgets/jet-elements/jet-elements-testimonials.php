...
class Amp_Jet_Elements_Testimonials extends Jet_Elements_Base {
	...
	protected function render() {
		...
		if($settings['autoplay'] != ""){
           $delay_time = $settings['autoplay_speed'];
           $autoplay = 'autoplay delay="'.$delay_time.'"';
		}

		$this->_open_wrap();
		echo '<amp-carousel class="jet-testimonials" width="400" height="250" layout="responsive" type="slides" '.$autoplay.'>';
		$this->amp_jet_get_global_looped_template( 'testimonials', 'item_list' );
		echo '</amp-carousel>';
		$this->_close_wrap();
	}
	...
	public function _get_testimonials_image() {
		...
		return sprintf( '<figure class="jet-testimonials__figure"><img class="jet-testimonials__tag-img" src="%1$s"></figure>',
			$image_item['url']
		);
	}
	...
	public function amp_jet_get_global_looped_template( $name = null, $setting = null, $callback = null ) {
