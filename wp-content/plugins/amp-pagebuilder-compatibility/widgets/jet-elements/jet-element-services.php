<?php
/**
 * Class: Amp_Jet_Elements_Services
 * Name: Services
 * Slug: jet-services
 */
...
class Amp_Jet_Elements_Services extends Jet_Elements_Base {
	...
	protected function render() {
     add_filter('amp_post_template_css', [$this,'jet_elements_services_custom_css'],999);
	...
	function jet_elements_services_custom_css(){
        echo ".jet-elements-icon .cls-1{fill:#bdd3e5;}
		.jet-elements-icon .cls-2{fill:#29415e;}
		.jet-elements-icon .st0{fill:#BDD3E5;}
		.jet-elements-icon .st1{fill:#29415E;}";
    }
