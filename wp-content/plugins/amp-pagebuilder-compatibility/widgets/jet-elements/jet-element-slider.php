...
class AMP_Jet_Elements_Slider extends Jet_Elements_Base {
	...
	public function _get_global_template( $name = null ) {
		...
		$template = call_user_func( array( $this, sprintf( '_get_%s_template', $this->_context ) ) );
	...
	protected function render() {
      add_filter('amp_post_template_css', [$this,'jet_elements_slider_custom_css'],999);
	...
	function jet_elements_slider_custom_css(){
		$settings = $this->get_settings_for_display();
		$unit = $settings['slider_height']['unit'];
		$height = $settings['slider_height']['size'];
		echo ".jet-slider .slider-pro {visibility: visible;}
		.jet-slider__items amp-carousel {height:auto;}
		.jet-slider__items .sp-thumbnail {
              display: none;
         }
        @media(min-width:768px){
	        .jet-slider__item amp-img {
			    align-items: center;
			    display: flex;
			    flex-wrap: wrap;
			    top: 25%;
        ...
        @media(max-width:768px){
        	.jet-slider__items amp-carousel {height: ".$height."".$unit.";}
			.jet-slider__item amp-img {
			    display: flex;
			    top: 25%;
			}
