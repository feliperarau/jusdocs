...
class AMP_Jet_Elements_Lottie extends Jet_Elements_Base {
	...
	protected function render() {
		...
		$width = $settings['lottie_width']['size'].$settings['lottie_width']['unit'];

		if(empty($settings['lottie_width']['size'])){
			$width = '360';
		}

		$inner = '<div class="jet-lottie__elem"><amp-bodymovin-animation layout="fixed" width="'.$width.'" height="200" src="'.$path.'"></amp-bodymovin-animation></div>';
		...
		printf( '<div class="jet-lottie">%1$s</div>', $inner );
