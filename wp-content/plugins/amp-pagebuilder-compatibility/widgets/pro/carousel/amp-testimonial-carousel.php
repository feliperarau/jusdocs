...
class Amp_Testimonial_Carousel extends Base {
	...
	public function testimonial_review_css(){
		echo '.swiper-wrapper amp-carousel{
			max-width:100%;
			max-height:330px;
		}
		.elementor-testimonial__image amp-img{
			margin:0 auto;
			max-width: 60px;
		}
		.ele-testimonial__text{white-space: normal;}';
	}

	private function print_cite( $slide, $location ) {
		add_filter('amp_post_template_css', [$this,'testimonial_review_css'],11);
			...
			<div class="elementor-testimonial__footer">
				<?php if ( $slide['image']['url'] ) : ?>
					<div class="elementor-testimonial__image">
						<amp-img layout="responsive" width="50px" height="50px" <?php echo $this->get_render_attribute_string( $element_key . '-image' ); ?>></amp-img>
					</div>
				<?php endif; ?>
