...
class AMP_Blockquote extends Base_Widget {
	...
	protected function render() {
        ...
        add_action('amp_post_template_css',[$this,'elementor_blockquote_custom_css'],999);
	...
	function elementor_blockquote_custom_css() {
		$settings = $this->get_settings_for_display();

	   echo '.ele-blockquote p:before {content: "";border-top: none;width: 115px;line-height: 40px;display: inline-block;position: absolute;top: 0;}';
	   if($settings['blockquote_skin'] == 'quotation'){
	     echo '.ele-blockquote__content {padding: 0;}';
	   }
