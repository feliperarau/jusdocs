...
class Amp_Lottie extends Base_Widget {
		...
		$this->start_controls_tabs( 'image_effects' );
			...
			$this->add_group_control(
				...
				[
					...
					'f' => '{{WRAPPER}} .e-lottie__container:hover',
				]
			);
	...
	protected function render() {
		...
		$widget_caption = '<amp-bodymovin-animation layout="fixed" width="200" height="200" src="'.$settings['source_json']['url'].'"></amp-bodymovin-animation>';
