...
class Nav_Menu extends Widget_Base {
	...
	protected function render() {
		...
		?>
		<div <?php echo $this->get_render_attribute_string( 'menu-toggle' ); ?> role="1" tabindex="2" [class]="menuclick? 'elementor-menu-toggle elementor-active': 'elementor-menu-toggle'" on="tap:AMP.setState({menuclick:(menuclick==1? 0: 1) })">
			<i class="eicon" aria-hidden="true"></i>
			<span class="elementor-screen-only"><?php _e( 'Menu', 'elementor-pro' ); ?></span>
		</div>
		<nav class="elementor-nav-menu--dropdown elementor-nav-menu__container" style="top: 33px;width: 800%;left: -257px;"><?php echo $dropdown_menu_html; ?></nav>
		<div class="elementor-menu-toggle elementor-active" style="display:none"><i></i></div>
		<?php
	}
