...
class AMP_Facebook_Comments extends Widget_Base {
	...
	public function render() {
        ...
        echo '<amp-facebook-comments width=786 height=657
        layout="responsive"
        data-numposts="5" ' . $this->get_render_attribute_string( 'embed_div' ) . '></amp-facebook-comments>'; // XSS ok.
	}
