...
class Amp_Slides extends Base_Widget {
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} {{CURRENT_ITEM}} .swiper-slide-inner .elementor-slide-content' => '{{VALUE}}',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .swiper-slide-bg' => 'animation-duration: calc({{VALUE}}ms*1.2); transition-duration: calc({{VALUE}}ms)',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-slides-wrapper .swiper-slider .swiper-prev:before, {{WRAPPER}} .elementor-slides-wrapper .swiper-slider .swiper-next:before' => 'font-size: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-slides-wrapper .swiper-slider .swiper-prev:before, {{WRAPPER}} .elementor-slides-wrapper .swiper-slider .swiper-next:before' => 'color: {{VALUE}};',
				],
				'condition' => [
					'navigation' => [ 'arrows', 'both' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-slides-wrapper .elementor-slides .swiper-dots li button:before' => 'font-size: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'navigation' => [ 'dots', 'both' ],
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-slides-wrapper .elementor-slides .swiper-dots li button:before' => 'color: {{VALUE}};',
				],
				'condition' => [
					'navigation' => [ 'dots', 'both' ],
				],
	...
	public function amp_ele_slides_custom_css(){
		    echo '.swiper-dots-inside amp-carousel{width: 100%;height:400px}.ele-slide-description {padding: 30px;}.ele-slide-content{ background: #ffffffb3;padding:17px;}
				@media  (max-width:775px){.ele-slide-content {position: relative;height: auto;
				}
	            .swiper-dots-inside amp-carousel{height: auto;}
				}.ect .ele-slides amp-carousel {max-width: 100%;}.ele-35 .ee.ebdb1 .ele-slide-content {max-width: 99%;}';
    }
	protected function render() {
		...
		if($swiper_options['autoplay'] == 1){
			$auto_play = 'autoplay'.' delay="'.$swiper_options['autoplaySpeed'].'"';
		...
		if ( $show_arrows ) {
			$carousel_classes[] = 'swiper-arrows-' . $settings['arrows_position'];
		}

		if ( $show_dots ) {
			$carousel_classes[] = 'swiper-dots-' . $settings['dots_position'];
		}
      ...
      add_action('amp_post_template_css',[$this,'amp_ele_slides_custom_css']);
		?>
		<div class="elementor-slides-wrapper elementor-swiper-slider" dir="<?php echo esc_attr( $direction ); ?>">
			<div <?php echo $this->get_render_attribute_string( 'slides' ); ?>>
            <amp-carousel width="400" height="300" layout="responsive" type="slides"<?php echo $auto_play ?>>
	...
	protected function _content_template() {
		...
		<#
			...
			if ( showArrows ) {
				var arrowsClass = 'swiper-arrows-' + settings.arrows_position;
			}

			if ( showDots ) {
				var dotsClass = 'swiper-dots-' + settings.dots_position;
			}

		#>
		<div class="elementor-slides-wrapper elementor-swiper-slider" dir="{{ direction }}">
