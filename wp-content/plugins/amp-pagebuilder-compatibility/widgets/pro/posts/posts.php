<?php
namespace ElementorForAmp\Widgets\Pro\Posts;

use Elementor\Controls_Manager;
use ElementorPro\Modules\QueryControl\Module as Module_Query;
use ElementorPro\Modules\QueryControl\Controls\Group_Control_Related;
//use ElementorPro\Modules\Posts\Skins;
use ElementorForAmp\Widgets\Pro\Posts\Skins;
...
class Posts extends \ElementorPro\Modules\Posts\Widgets\Posts_Base {
	...
	protected function _register_skins() {
		$this->add_skin( new Skins\AMP_Skin_Classic( $this ) );
		$this->add_skin( new Skins\Amp_Skin_Cards( $this ) );
		//$this->add_skin( new Skins\Amp_Skin_Full_Content( $this ) );
	}
