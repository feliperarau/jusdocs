...
class Amp_Skin_Posts_ECS extends \ElementorForAmp\Widgets\Pro\Posts\Skins\Skin_Base {
...
//	private $template_cache=[];
  ...
  public function end_grid(){
	...
	protected function amp_get_template(){
   ...
   ?>
    ...
    do_action( 'ECS_after_render_post_header', $this );
      ...
      if ($this->get_instance_value( 'use_keywords' ) == "yes") {
        ...
        $template = $this->amp_get_template();
        ...
        else echo $this->amp_get_template(); 
    }
  ...
  public function amp_tester_content_getter(){
	...
	if ( $query->in_the_loop ) {
		...
		echo amp_get_template();
	} else {
		while ( $query->have_posts() ) {
			$query->the_post();
			$this->render_post_header();
			$this->current_permalink = get_permalink();
			echo $this->amp_get_template();
			$this->render_post_footer();
		}
	}
 	...
 	$content = '<div data-elementor-type="wp-post" data-elementor-id="'.$id.'" class="elementor elementor-'.$id.'" data-elementor-settings="[]">
					       				...
					       				<div class="elementor-column elementor-top-column elementor-element" data-element_type="column">
			                 				<div class="elementor-column-wrap elementor-element-populated">
							   					<div class="elementor-widget-wrap">
						        					<div class="elementor-element elementor-element-7e510b72 elementor-posts--thumbnail-top elementor-grid-3 elementor-grid-tablet-2 elementor-grid-mobile-1 elementor-widget elementor-widget-posts" data-widget_type="posts.custom">
								  						<div class="elementor-widget-container">'.$myc.'
								  					</div>
												</div>
							 				</div>
						   				</div>
	...
	$content_obj = new \AMPFORWP_Content( $content,
						array(), 
	...
	$sanitizer_content = $content_obj->get_amp_content();

	return $sanitizer_content;

  }
  
  public function render() {

  	//add_filter('ampforwp_modify_the_content',[ $this, 'amp_tester_content_getter' ] );
...
class Amp_Skin_Archive_ECS extends Amp_Skin_Posts_ECS {
