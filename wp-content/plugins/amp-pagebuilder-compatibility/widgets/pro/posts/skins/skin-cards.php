...
class Amp_Skin_Cards extends \ElementorForAmp\Widgets\Pro\Posts\Skins\Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		add_action('amp_post_template_css',[ $this, 'amp_skin_card_custom_css' ] );
	}
  ...
  public function amp_skin_card_custom_css() {

    echo 	'.content-wrapper .elementor-post__thumbnail.amp amp-img{
				max-width:100%;
				}
			.elementor-posts .elementor-pst_card .elementor-pst_text {
			    padding: 0 30px;
			}';
  }
	...
	protected function render_thumbnail() {
		...
		<a class="elementor-post__thumbnail__link" href="<?php echo get_permalink(); ?>">
			<div class="elementor-post__thumbnail amp" >
