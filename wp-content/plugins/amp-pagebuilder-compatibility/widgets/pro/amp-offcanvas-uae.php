 ...
 * Class Offcanvas.
 */
class amp_uae_Offcanvas extends Common_Widget {
	...
	protected function render() {
		...
		$side_ofcanvas = ($settings['offcanvas_position'] == 'at-right') ? 'right' : 'left';
		?>
		<amp-sidebar id="sidebar" class="sample-sidebar" layout="nodisplay" side="<?php echo $side_ofcanvas ?>">
			...
			<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'inner-wrapper' ) ); ?>>
				<div class="uael-offcanvas-content">
					<div class="uael-offcanvas-action-wrap">
						<button class="uael-offcanvas-close-icon-wr elementor-icon-wr elementor-clickable uael-offcanvas-close-icon-position-right-top" on="tap:sidebar.close" style="background: transparent;">
