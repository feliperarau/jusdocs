...
class AMP_EB_Google_Map_Extended extends Widget_Base {
...
public function get_option( $option, $section, $default = '' ) {
	...
	protected function render() {
		$this->google_map_api = $this->get_option( 'eb_google_map_api_key','eb_map_general_settings' );
		...
		<div id="eb-map-<?php echo esc_attr($this->get_id()); ?>">
			<amp-iframe 
			  width="600" 
              height="<?php echo $settings['height']['size'];?>" 
              title="<?php echo $item['pin_title'];?>"
              layout="responsive" 
              sandbox="allow-scripts allow-same-origin allow-popups" 
              frameborder="0"
              src="https://www.google.com/maps/embed/v1/view?key=<?php echo $this->google_map_api;?>&center=<?php echo $item['pin_lat'];?>,<?php echo $item['pin_lng'];?>&zoom=<?php echo $settings['zoom']['size'] ;?>">
            </amp-iframe>
        </div>
