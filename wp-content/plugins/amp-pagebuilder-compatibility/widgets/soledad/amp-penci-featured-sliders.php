...
namespace ElementorForAmp\Widgets\Soledad;
...
class Amp_PenciFeaturedSliders extends Base_Widget {
	...
	protected function _register_controls() {
		...
		$list_switchers = array(
			...
			'show_cat'         => array(
				...
				'desc'	=> 'By default, we disabled categories for some slider styles & some small posts - this option will help you show it if you want.',
			),
	...
	protected function render() {
		...
		echo '<amp-carousel height="300" layout="fixed-height" type="carousel" class="penci-owl-carousel penci-owl-featured-area owl-loaded elsl-'. $slider_class .'" controls>';
		include get_template_directory()."/inc/elementor/modules/penci-featured-sliders/widgets/{$slider_style}.php";
		echo '</amp-carousel';
		echo '</div>';
	}
