 ...
 * @since 1.0.0
 */
class AMP_Widget_Icon_List extends Widget_Base {
	 ...
	 * @access protected
	 */
    public function amp_icon_list_styles(){
		$custom_styles = "";
	    $custom_styles = '.elementor-icon-list-icon i.fas {font-weight: 900;}';
        echo $custom_styles;
  	}

	protected function render() {
		$settings = $this->get_settings_for_display();
		add_action('amp_post_template_css',array($this,'amp_icon_list_styles'));
		$fallback_defaults = [
			'fa fa-check',
			'fa fa-times',
			'fa fa-dot-circle-o',
