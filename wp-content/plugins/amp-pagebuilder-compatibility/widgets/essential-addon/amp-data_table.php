...
class AMP_Data_Table extends Widget_Base {
	...
	public function amp_data_table_styles(){
		$settings = $this->get_settings_for_display();
		$custom_styles = "";
		if($settings['table_alignment'] == "center"){
	       $custom_styles = '.eael-data-table-wrap{text-align: center;}.eael-data-table-wrap table {text-shadow: unset;}';
		}
        echo $custom_styles;
  	}

	protected function render( ) {
        add_action('amp_post_template_css',array($this,'amp_data_table_styles'));
        $settings = $this->get_settings_for_display();
        $table_tr = [];
		$table_td = [];
