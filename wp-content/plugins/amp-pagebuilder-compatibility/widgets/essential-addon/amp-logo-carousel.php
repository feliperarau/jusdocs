 ...
 */
class Amp_ea_Logo_Carousel extends Widget_Base {
    ...
    protected function render() {
        ...
        <div <?php echo $this->get_render_attribute_string( 'logo-carousel-wrap' ); ?>>
            <div <?php echo $this->get_render_attribute_string( 'logo-carousel' ); ?>>
                <div class="ealogo-ampwrpr">
                <amp-carousel class="ea-logo-crsl" height="170" layout="fixed-height" type="carousel" controls>
                <?php
$i = 1;
