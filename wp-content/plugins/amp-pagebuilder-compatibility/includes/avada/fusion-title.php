	...
	if ( ! class_exists( 'AMP_PC_FusionSC_Title' ) ) {
		...
		class AMP_PC_FusionSC_Title extends Fusion_Element {
			...
			public function __construct() {
				...
				add_action( 'amp_post_template_css', array( $this, 'amp_pc_title_styles' ) );
 ...
 * @since 1.0
 */
function amp_fusion_element_title() {
...
add_action( 'fusion_builder_before_init', 'amp_fusion_element_title' );
