	...
	if ( ! class_exists( 'AMP_PC_FusionSC_Tagline' ) ) {
		...
		class AMP_PC_FusionSC_Tagline extends Fusion_Element {
			...
			public function __construct() {
				...
				add_action('amp_post_template_css', array( $this,'amp_pc_tagline_styles') );
 ...
 * @since 1.0
 */
function amp_fusion_element_tagline_box() {
...
add_action( 'fusion_builder_before_init', 'amp_fusion_element_tagline_box' );
