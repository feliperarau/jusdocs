...
if ( fusion_is_element_enabled( 'fusion_map' ) ) {
	...
	if ( ! class_exists( 'AMP_PC_FusionSC_GoogleMap' ) ) {
		/**
		 * Shortcode class.
		 *
		 ...
		 * @since 1.0
		 */
		class AMP_PC_FusionSC_GoogleMap extends Fusion_Element {
			...
			public function add_options() {
				...
				return array(
					'google_map_shortcode_section' => array(
 ...
 * @since 1.0
 */
function amp_fusion_element_google_map() {
	fusion_builder_map(
		array(
			...
			'params'     => array(
				...
				array(
					...
					'description'      => __( 'Map dimensions in percentage, pixels or ems. <strong>NOTE:</strong> Height does not accept percentage value. In case static API is selected width and height are limited to 640px (except for the premium Google Maps API plan).', 'fusion-builder' ),
...
add_action( 'fusion_builder_before_init', 'amp_fusion_element_google_map' );
