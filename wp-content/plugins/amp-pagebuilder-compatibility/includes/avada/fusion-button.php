...
if ( fusion_is_element_enabled( 'fusion_button' ) ) {
	...
	if ( ! class_exists( 'AMP_PC_FusionSC_Button' ) ) {
		/**
		 * Shortcode class.
		 *
		 ...
		 * @since 1.0
		 */
		class AMP_PC_FusionSC_Button extends Fusion_Element {
			...
			public function __construct() {
				...
				add_action( 'amp_post_template_css', array( $this, 'amp_pc_fu_button_styles' ) );
				add_shortcode( 'fusion_button', array( $this, 'render' ) );
			}
			public function amp_pc_fu_button_styles(){
				echo $this->amp_button_styles;
				//echo 'default_type{'.$defaults['button_gradient_top_color'].''}';
			}
