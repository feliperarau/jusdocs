...
if ( fusion_is_element_enabled( 'fusion_separator' ) ) {
	...
	if ( ! class_exists( 'AMP_PC_FusionSC_Separator' ) ) {
		/**
		 * Shortcode class.
		 *
		 ...
		 * @since 1.0
		 */
		class AMP_PC_FusionSC_Separator extends Fusion_Element {
	...
	remove_shortcode('fusion_separator');
	new AMP_PC_FusionSC_Separator();
 ...
 * @since 1.0
 */
function amp_fusion_element_separator() {
...
add_action( 'fusion_builder_before_init', 'amp_fusion_element_separator' );
