<?php
if(!class_exists('AMP_PC_ET_Builder_Module_Contact_Form_Item')){

class AMP_PC_ET_Builder_Module_Contact_Form_Item extends ET_Builder_Module {
	function init() {
...
$contactFormItemObj = new AMP_PC_ET_Builder_Module_Contact_Form_Item();
remove_shortcode( 'et_pb_contact_field' );
add_shortcode( 'et_pb_contact_field', array( $contactFormItemObj, '_render' ));
}