...
class Amp_ET_Theme_Builder_Request {
	/**
	 * Type constants.
	 */
	...
	public static function from_current() {
		...
		if ( $is_extra_layout_home || (function_exists('ampforwp_is_front_page') && ampforwp_is_front_page() && function_exists('ampforwp_get_frontpage_id')) ) {
			return new self( self::TYPE_SINGULAR, 'page', ampforwp_get_frontpage_id() );
		}
