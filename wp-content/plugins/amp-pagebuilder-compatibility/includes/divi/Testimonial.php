...
if(!class_exists('AMP_PC_ET_Builder_Module_Testimonial')){
class AMP_PC_ET_Builder_Module_Testimonial extends ET_Builder_Module {
	function init() {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$output                    = sprintf(
			'<div%3$s class="a-tstml"%10$s%11$s>
				%9$s
				%8$s
				%7$s
				<div class="et_pb_testimonial_description">
					<div class="et_pb_testimonial_description_inner">%1$s
					%2$s
...
$accordianItemObj = new AMP_PC_ET_Builder_Module_Testimonial();//et_pb_accordion_item
remove_shortcode( 'et_pb_testimonial' );
add_shortcode( 'et_pb_testimonial', array($accordianItemObj, '_render'));
}