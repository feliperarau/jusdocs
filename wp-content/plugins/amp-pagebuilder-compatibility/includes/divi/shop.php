<?php
if(!class_exists('AMP_PC_ET_Builder_Module_Shop')){

class AMP_PC_ET_Builder_Module_Shop extends ET_Builder_Module_Type_PostBased {
	function init() {
	...
	function amp_divi_shop_page_styles(){
		$inline_styles = '.e_shop .woocommerce ul.products li.product{float:left;}
.e_shop .woocommerce ul.products{list-style:none outside;}';
		echo $inline_styles;
	}
	function render( $attrs, $content = null, $render_slug='' ) {
		add_action('amp_post_template_css',[$this,'amp_divi_shop_page_styles']);
		$type                    = $this->props['type'];
...
$mapObj = new AMP_PC_ET_Builder_Module_Shop();
remove_shortcode( 'et_pb_shop' );
add_shortcode( 'et_pb_shop', array($mapObj, '_render'));
} 