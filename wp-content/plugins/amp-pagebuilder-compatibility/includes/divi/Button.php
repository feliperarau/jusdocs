<?php
if(!class_exists('AMP_PC_ET_Builder_Module_Button')){
class AMP_PC_ET_Builder_Module_Button extends ET_Builder_Module {
	function init() {
	...
	function ampdivi_border_css(){
		echo "div.ebtn,div.ebtn:hover{border: none;}";
	}
	function render( $attrs, $content = null, $render_slug='' ) {
	    ...
	    add_action('amp_post_template_css',array($this,'ampdivi_border_css'));
		...
		if(function_exists('ampforwp_get_setting') && (true == ampforwp_get_setting('convert-internal-nonamplinks-to-amp')) && function_exists('ampforwp_url_controller')){
			$button_url = ampforwp_url_controller($button_url);
		}
		...
		if(empty($button_url)){
			$button_url = ampforwp_url_controller(get_the_permalink($post_id));
		}
		// Render Button
...
$countdownTimerObj = new AMP_PC_ET_Builder_Module_Button();
remove_shortcode( 'et_pb_button' );
add_shortcode( 'et_pb_button', array($countdownTimerObj, '_render'));
}