<?php
if(!class_exists('AMP_PC_ET_Builder_Module_Accordion')){
class AMP_PC_ET_Builder_Module_Accordion extends ET_Builder_Module {
	function init() {
...
.et_pb_accordion .et_pb_toggle[expanded] .et_pb_toggle_title:before {
    color: #ccc;
}
';
...
$accordianItemObj = new AMP_PC_ET_Builder_Module_Accordion();//et_pb_accordion_item
