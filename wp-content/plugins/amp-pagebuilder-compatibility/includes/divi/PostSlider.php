...
if(!class_exists('AMP_PC_ET_Builder_Module_Post_Slider')){
class AMP_PC_ET_Builder_Module_Post_Slider extends ET_Builder_Module_Type_PostBased {
	function init() {
	...
	function amp_divi_post_slider_styles(){
		$inline_styles = '.et_pb_post_slider .et_pb_slides .et_pb_slider_container_inner{display:inline-block;}.et_pb_post_slider .et_pb_slider .et_pb_slide{margin-right:0px;}';
		echo $inline_styles;
	}
	function render( $attrs, $content = null, $render_slug='' ) {
		global $post;
		add_action('amp_post_template_css',[$this,'amp_divi_post_slider_styles']);
		...
		$output = sprintf(
			'<div%3$s class="%1$s"%7$s%8$s>
				%5$s
				%4$s
				<amp-carousel class="et_pb_slides" width="400" height="300" layout="responsive" type="slides">
					%2$s
...
$PostSliderObj = new AMP_PC_ET_Builder_Module_Post_Slider();
