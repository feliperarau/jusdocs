<?php
if(!class_exists('AMP_PC_ET_Builder_Module_Map')){
class AMP_PC_ET_Builder_Module_Map extends ET_Builder_Module {
	function init() {
	...
	function render( $attrs, $content = null, $render_slug='' ) {
		...
		$output = sprintf(
			...
			<amp-iframe width="600" title="Google map pin on Googleplex, Mountain View CA"
                          ...
                          frameborder="0"
						  data-zoom="%3$d" data-mouse-wheel="%7$s"
						   data-mobile-dragging="%9$s"
                          src="https://maps.google.com/maps?q=%1$s,%2$s&center=(%1$s,%2$s)&zoom=%3$s&output=embed">%4$s</amp-iframe></div>',
...
$mapObj = new AMP_PC_ET_Builder_Module_Map();
