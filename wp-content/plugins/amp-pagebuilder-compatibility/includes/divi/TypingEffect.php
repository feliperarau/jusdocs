<?php
if(!class_exists('AMP_PC_ET_DSM_TypingEffect')){
class AMP_PC_ET_DSM_TypingEffect extends ET_Builder_Module {
	...
	public function render( $attrs, $content = null, $render_slug='' ) {
		...
		if ( '' !== $typing_effect ) {
			$typing_effect = sprintf(
				'<%1$s class="dsm-typing-effect et_pb_module_header"><span class="dsm-typing" data-dsm-typing-strings="%2$s"%3$s%4$s>%2$s</span></%1$s>',
...
$typingEffectObj = new AMP_PC_ET_DSM_TypingEffect();
remove_shortcode( 'dsm_typing_effect' );
add_shortcode( 'dsm_typing_effect', array($typingEffectObj, '_render'));
}