<?php
if(!class_exists('AMP_PC_ET_Builder_Module_Toggle')){
class AMP_PC_ET_Builder_Module_Toggle extends ET_Builder_Module {
function init() {
...
$amp_divi_shortcodes = new AMP_PC_ET_Builder_Module_Toggle();
