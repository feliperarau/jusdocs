<?php
if(!class_exists('AMP_PC_ET_Builder_Module_Map_Item')){
class AMP_PC_ET_Builder_Module_Map_Item extends ET_Builder_Module {
	function init() {
...
$mapItemObj = new AMP_PC_ET_Builder_Module_Map_Item();
remove_shortcode( 'et_pb_map_pin' );
add_shortcode( 'et_pb_map_pin', array($mapItemObj, '_render'));
}