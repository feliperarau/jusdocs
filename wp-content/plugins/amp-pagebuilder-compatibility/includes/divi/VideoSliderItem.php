<?php
if(!class_exists('AMP_PC_ET_Builder_Module_Video_Slider_Item')){
class AMP_PC_ET_Builder_Module_Video_Slider_Item extends ET_Builder_Module {
	function init() {				
	...
	function render( $attrs, $content = null, $render_slug='' ) {
		...
		/*$test = $test2 = '';	
		//echo $this->module_classname( $render_slug )."hello!\n";
		if( $this->module_classname( $render_slug ) == 'et_pb_slide' ){
		$test = '<amp-carousel class="amp-video-slider" height="300" width="300" type="slides" layout="responsive">';
		$test2 = '</amp-carousel>';
		}*/
		$output = sprintf(
...
$VideosliderItemObj = new AMP_PC_ET_Builder_Module_Video_Slider_Item();//et_pb_video_slider_item
