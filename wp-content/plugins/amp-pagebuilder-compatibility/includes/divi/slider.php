<?php
if(!class_exists('AMP_PC_ET_Builder_Module_Slider')){
class AMP_PC_ET_Builder_Module_Slider extends ET_Builder_Module {
	function init() {
	...
	function sliderStyle(){
		?>/*.et_pb_slides .et_pb_slide{height:auto;}*/.et_pb_slider .et_pb_slide{
			    margin: 0;
				padding:0;
		}.et_pb_slides .et_pb_container{display:block;}
		.e_slides .e_sl_container_inner{display: contents;}
		#page-container .e_slideim amp-img {width: 350px;height: auto;}
		@media(max-width:768px){
		#page-container .e_slideim amp-img {width: 200px;height: auto;}
		}
		@media(min-width:1175px){
			#p-c .e_slideim amp-img {
			    display: block;
			    position: relative;
			    left: 8em;
			    top: 5em;
		...
		#hero-slides amp-carousel {
         height: auto;
         position: initial;
        }
        @media (max-width: 479px){
	        .e_sl_fullwidth_off .e_s_c, .e_sl_fullwidth_off .e_morebtn {
	           display: inline;
	        }
        }
		.e_sl_0 .e_sd, .e_sl_fullwidth_off.e_sl_0 .e_sd {
          padding: 16% 8%;
        }
		<?php
	}
	...
	function render( $attrs, $content = null, $render_slug='' ) {
		add_action('amp_post_template_css', array($this, 'sliderStyle'), 11);
		...
		$output = sprintf(
			'<div%3$s class="%1$s">
					<amp-carousel  width="250" height="120" class="et_pb_slides" layout="responsive" type="slides"> 
					%2$s
					</amp-carousel>
				%4$s
			</div> <!-- .et_pb_slider -->
...
$sliderObj = new AMP_PC_ET_Builder_Module_Slider();//et_pb_accordion_item
