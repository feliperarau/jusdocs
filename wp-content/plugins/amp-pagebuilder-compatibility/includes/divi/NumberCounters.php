<?php
if(!class_exists('AMP_PC_ET_Builder_Module_Number_Counter')){
class AMP_PC_ET_Builder_Module_Number_Counter extends ET_Builder_Module {
	function init() {
	...
	function render( $attrs, $content = null, $render_slug='' ) {
		...
		$output = sprintf(
			'<div%1$s class="%2$s" data-number-value="%3$s" data-number-separator="%7$s" style="opacity:1;">
				%9$s
				%8$s
...
add_action('amp_post_template_css','custom_amp_divi_css',999);
function custom_amp_divi_css(){
  echo '.enumcounter {visibility:visible;}';
}

$numberCounterObj = new AMP_PC_ET_Builder_Module_Number_Counter();
