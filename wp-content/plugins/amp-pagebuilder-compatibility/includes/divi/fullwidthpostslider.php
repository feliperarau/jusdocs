<?php
if(!class_exists('AMP_ET_Builder_Module_Fullwidth_Post_Slider')){
class AMP_ET_Builder_Module_Fullwidth_Post_Slider extends ET_Builder_Module_Type_PostBased {
	function init() {
    ...
    function sliderStyle(){
		?>.et_pb_post_slider .et_pb_slide{margin: 0; padding:0; }.et_pb_post_slider .et_pb_slide{display:block;}<?php
	}
...
$Fullwidth_PostsliderObj = new AMP_ET_Builder_Module_Fullwidth_Post_Slider();//et_pb_accordion_item
remove_shortcode( 'et_pb_fullwidth_post_slider' );
add_shortcode( 'et_pb_fullwidth_post_slider', array($Fullwidth_PostsliderObj, '_render'));
}