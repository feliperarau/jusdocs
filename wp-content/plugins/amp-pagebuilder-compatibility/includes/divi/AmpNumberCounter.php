<?php
if(!class_exists('AMP_ET_Builder_Module_Number_Counter')){
class AMP_ET_Builder_Module_Number_Counter extends ET_Builder_Module {
	...
	function render( $attrs, $content = null, $render_slug='' ) {
		...
		$output = sprintf(
			'<div%1$s class="%2$s active" data-number-value="%3$s" data-number-separator="%7$s"%10$s%11$s>
				%9$s
				%8$s
...
new AMP_ET_Builder_Module_Number_Counter;
$countdownTimerObj = new AMP_ET_Builder_Module_Number_Counter();
remove_shortcode( 'et_pb_number_counter' );
add_shortcode( 'et_pb_number_counter', array($countdownTimerObj, '_render'));
}