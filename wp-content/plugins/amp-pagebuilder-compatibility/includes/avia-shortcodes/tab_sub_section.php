...
if ( ! class_exists( 'amp_avia_sc_tab_sub_section' ) )
{
	class amp_avia_sc_tab_sub_section extends aviaShortcodeTemplate
	{
		static $extraClass = '';
		...
		function shortcode_handler( $atts, $content = '', $shortcodename = '', $meta = '' )
		{
			...
			if( amp_avia_sc_tab_sub_section::$attr['content_height'] == 'av-tab-content-auto' )
			{
			...
			else if( amp_avia_sc_tab_sub_section::$attr['initial'] > avia_sc_tab_section::$tab ) 
			{
				avia_sc_tab_sub_section::$attr['initial'] = avia_sc_tab_section::$tab;
			}
				
			$active_tab = avia_sc_tab_section::$tab == avia_sc_tab_sub_section::$attr['initial'] ? 'av-active-tab-content' : '';
			...
			$output = '<div id="'.$tab_link.'" role="tab" aria-controls="'.$tab_link.'-tabpanel" option '.$selected_section.' style="display:none;">Tab one</div>';
			$output  .= '<div id="'.$tab_link.'-tabpanel" role="tabpanel" aria-labelledby="'.$tab_link.'" [class]="activeTab=='.avia_sc_tab_section::$tab.'?\'av-layout-tab av-animation-delay-container av-active-tab-content '.$meta['el_class'].' '.$extraClass.' '.amp_avia_sc_tab_sub_section::$extraClass.'\':\'av-layout-tab av-animation-delay-container '.$meta['el_class'].' '.$extraClass.' '.amp_avia_sc_tab_sub_section::$extraClass.'\'" class="av-layout-tab av-animation-delay-container '.$active_tab.' '.$meta['el_class'].' '.$extraClass.' '.amp_avia_sc_tab_sub_section::$extraClass.'" '.$outer_style.' '.$data.'>';
