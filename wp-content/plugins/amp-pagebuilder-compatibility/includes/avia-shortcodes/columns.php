...
if ( !class_exists( 'amp_avia_sc_columns' ) )
{
	class amp_avia_sc_columns extends aviaShortcodeTemplate
	{
			...
			{
				return isset( amp_avia_sc_columns::$size_array[ $this->config['shortcode'] ] ) ? amp_avia_sc_columns::$size_array[ $this->config['shortcode'] ] : 1.0;
			}
...
*/
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				if( $first )
				{
					amp_avia_sc_columns::$first_atts = $atts;
				}
				...
				if( !empty( amp_avia_sc_columns::$first_atts['space'] ) )
				{
					$extraClass .= " ".amp_avia_sc_columns::$first_atts['space'];
				}
				
				if( !empty( amp_avia_sc_columns::$first_atts['mobile_breaking'] ) )
				{
					$extraClass .= " ".amp_avia_sc_columns::$first_atts['mobile_breaking'];
					$extra_table_class = " av-break-at-tablet-table";
				}
				
				
				if( !empty( amp_avia_sc_columns::$first_atts['min_height'] ) )
				{
					$extraClass .= " flex_column_table_cell";
					$extraClass .= " ".amp_avia_sc_columns::$first_atts['min_height']." ".amp_avia_sc_columns::$first_atts['vertical_alignment'];
				}
				else
				{
				...
				if( !empty( amp_avia_sc_columns::$first_atts['custom_margin'] ) )
				{
					$explode_margin = explode(',',amp_avia_sc_columns::$first_atts['margin']);
                ...
                */
				...
				if( $first )
				{	
					amp_avia_sc_columns::$calculated_size = 0;
					...
					{
						amp_avia_sc_columns::$extraClass = "column-top-margin";
					}
					else
					{
						amp_avia_sc_columns::$extraClass = "";
					}
				}
				

				if(!empty( amp_avia_sc_columns::$first_atts['min_height'] ) && amp_avia_sc_columns::$calculated_size == 0)
				{
					$output .= "<div class='flex_column_table ".amp_avia_sc_columns::$first_atts['min_height']."-flextable ".amp_avia_sc_columns::$first_atts['mobile_breaking']."-flextable' {$row_style}>";
				}	
				
				if(!$first && empty( amp_avia_sc_columns::$first_atts['space'] ) && !empty( amp_avia_sc_columns::$first_atts['min_height'] ))
				{
					$output .= "<div class='av-flex-placeholder'></div>";
				}

				amp_avia_sc_columns::$calculated_size += amp_avia_sc_columns::$size_array[ $this->config['shortcode'] ];
				...
				$output  .= '<div class="flex_column '. $shortcodename . ' ' . $extraClass . ' ' . $first.' ' . $meta['el_class'] . ' ' . amp_avia_sc_columns::$extraClass . '" ' . $outer_style .' '. $link_data . '>';
				...
				{
					if(!array_key_exists($meta['siblings']['next']['tag'], amp_avia_sc_columns::$size_array))
					{
						$force_close = true;
					}
				}
				 ...
				 */
				if( ( false === $force_close ) && ! empty( amp_avia_sc_columns::$first_atts['min_height'] ) && ( 'av-equal-height-column' ==  amp_avia_sc_columns::$first_atts['min_height'] ) )
				{
					if( ! isset( $meta['siblings']['next']['tag'] ) )
					{
						//$force_close = true;
					}
					else if( ( amp_avia_sc_columns::$calculated_size + amp_avia_sc_columns::$size_array[ $meta['siblings']['next']['tag'] ] ) > 1.0 )
					{
						$force_close = true;
					}
				}
				
				if( !empty( amp_avia_sc_columns::$first_atts['min_height']) && (amp_avia_sc_columns::$calculated_size >= 0.95 || $force_close) )
				{
...
if ( !class_exists( 'amp_avia_sc_columns_one_half' ) )
{
	class amp_avia_sc_columns_one_half extends amp_avia_sc_columns{
...
if ( !class_exists( 'amp_avia_sc_columns_one_third' ) )
{
	class amp_avia_sc_columns_one_third extends amp_avia_sc_columns{
...
if ( !class_exists( 'amp_avia_sc_columns_two_third' ) )
{
	class amp_avia_sc_columns_two_third extends amp_avia_sc_columns{
...
if ( !class_exists( 'amp_avia_sc_columns_one_fourth' ) )
{
	class amp_avia_sc_columns_one_fourth extends amp_avia_sc_columns{
...
if ( !class_exists( 'amp_avia_sc_columns_three_fourth' ) )
{
	class amp_avia_sc_columns_three_fourth extends amp_avia_sc_columns{
...
if ( !class_exists( 'amp_avia_sc_columns_one_fifth' ) )
{
	class amp_avia_sc_columns_one_fifth extends amp_avia_sc_columns{
...
if ( !class_exists( 'amp_avia_sc_columns_two_fifth' ) )
{
	class amp_avia_sc_columns_two_fifth extends amp_avia_sc_columns{
...
if ( !class_exists( 'amp_avia_sc_columns_three_fifth' ) )
{
	class amp_avia_sc_columns_three_fifth extends amp_avia_sc_columns{
...
if ( !class_exists( 'amp_avia_sc_columns_four_fifth' ) )
{
	class amp_avia_sc_columns_four_fifth extends amp_avia_sc_columns{
