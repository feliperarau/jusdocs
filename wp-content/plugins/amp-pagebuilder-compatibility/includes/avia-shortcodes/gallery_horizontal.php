...
if ( !class_exists( 'amp_avia_sc_gallery_horizontal' ) )
{
	class amp_avia_sc_gallery_horizontal extends aviaShortcodeTemplate
	{
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				if(!empty($attachments) && is_array($attachments))
				{
					...
					$output .= "<div class='av-horizontal-gallery-{$gap}-gap av-horizontal-gallery-{$active}-effect av-horizontal-gallery-".self::$hor_gallery." ".$meta['el_class']." {$control_layout} {$av_display_classes}' {$markup} {$padding} {$initial}>";
					
					//$output .= $this->slide_navigation_arrows();

					
					//$output .= "<div class='av-horizontal-gallery-inner'>";
					$output .= '<amp-carousel width="400" height="300" layout="responsive" type="slides" class="av-horizontal-gallery-slider">';
					...
					foreach($attachments as $attachment)
					{
						...
						$output .= "<div class='av-horizontal-gallery-wrap noHover'>";
								...
								$output .= "<amp-img class='av-horizontal-gallery-img' ";
								$output .= "width='400' height='300' src='".$img[0]."' title='".$title."' alt='".$alt."' layout='responsive'></amp-img>";	
