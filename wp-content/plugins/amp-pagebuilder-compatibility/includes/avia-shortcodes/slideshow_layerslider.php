...
if ( ! class_exists( 'amp_pc_avia_sc_layerslider' ) ) 
{
	class amp_pc_avia_sc_layerslider extends aviaShortcodeTemplate
	{		
			...
			{
				remove_shortcode('av_layerslider');
			...
			public function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = array() )
			{
				...
				amp_pc_avia_sc_layerslider::$slide_count++;
				...
				{		
					...
					add_filter('layerslider_slider_markup', array($this, 'updateSliderMarkup'), 10, 3);
					$atts['id'] = $slider['id'];
				...
				$params['id'] = "layer_slider_".( amp_pc_avia_sc_layerslider::$slide_count );
				...
				$output .= avia_new_section(array('close'=>false, 'id' => "after_layer_slider_".amp_pc_avia_sc_layerslider::$slide_count));
			...
			function updateSliderMarkup($outputmarkup, $slider, $sID){
