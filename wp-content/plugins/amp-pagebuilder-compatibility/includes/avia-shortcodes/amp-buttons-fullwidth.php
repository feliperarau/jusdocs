...
if ( !class_exists( 'amp_avia_sc_button_full' ) ) 
{
	class amp_avia_sc_button_full extends aviaShortcodeTemplate
	{
			static $count = 0;
		  ...
		  if($atts['color'] == "theme-color" || $atts['color'] == "theme-color-highlight" || $atts['color'] == "theme-color-subtle"){
		  	   add_filter('amp_post_template_css','amp_fullwidth_button_css',999);
		  }
				...
				$params['id'] = !empty($id) ? $id : "av-fullwidth-button-".amp_avia_sc_button_full::$count;
	...
	function amp_fullwidth_button_css(){
		echo ".avia-button {background-color: #507210;}";
	}
