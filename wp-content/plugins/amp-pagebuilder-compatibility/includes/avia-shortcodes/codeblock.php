...
if ( !class_exists( 'amp_avia_sc_codeblock' ) )
{
    class amp_avia_sc_codeblock extends aviaShortcodeTemplate
    {
        ...
        public function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
        {
           ...
           // $content = ' [avia_codeblock_placeholder uid="' . amp_avia_sc_codeblock::$codeblock_id . '"] ';
            ...
            if(empty($atts['deactivate_wrapper']))
            {
                ...
                $output .= '<section class="avia_codeblock_section '.$av_display_classes.' avia_code_block_' . amp_avia_sc_codeblock::$codeblock_id . '" ' . $markup . '>';
                $output .=		"<div class='avia_codeblock {$custom_class}' $markup_text>" . $content . "</div>";
                $output .= '</section>';
                $content = $output;
            }

			ShortcodeHelper::$shortcode_index += amp_avia_sc_codeblock::$shortcodes_executed[ amp_avia_sc_codeblock::$codeblock_id ];
			
            amp_avia_sc_codeblock::$codeblock_id++;
            return $content;
        }
		 ...
		 * ( see amp_avia_sc_codeblock::code_block_injection() ).
		 * 
		...
		{	
			...
			foreach( $matches[0] as $key => $data )
			{
				...
				amp_avia_sc_codeblock::$shortcodes_executed[] = ShortcodeHelper::$direct_calls;
			}
		 ...
		 * amp_avia_sc_codeblock::code_block_extraction.
		 * 
		 * @param string $content
		 * @return string
		 */
