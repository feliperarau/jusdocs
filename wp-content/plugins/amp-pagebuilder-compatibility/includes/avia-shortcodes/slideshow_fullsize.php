...
if ( !class_exists( 'amp_avia_sc_slider_full' ) ) 

		
{
	class amp_avia_sc_slider_full extends aviaShortcodeTemplate

	{
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				$skipSecond = false;
				amp_avia_sc_slider_full::$slide_count++;
				...
				$params['id'] = "full_slider_".amp_avia_sc_slider_full::$slide_count;
				...
				$output .= avia_new_section(array('close'=>false, 'id' => "after_full_slider_".amp_avia_sc_slider_full::$slide_count));
