...
if ( !class_exists( 'amp_avia_sc_animated_numbers' ) ) 
{
	
	class amp_avia_sc_animated_numbers extends aviaShortcodeTemplate
	{
			/**
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
        		...
        		$output  = '<'.$tags[0].' '.$style.' class="avia-animated-number '.$av_display_classes.' avia-color-'.$color.' '.$meta['el_class'].' avia_animate_when_visible" '.$style.'>';
