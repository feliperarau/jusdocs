<?php
/**
 * TransactionalNotificationCtaAlt Email Template component
 *
 * @package joyjet
 */
 ...
 */
class TransactionalNotificationCtaAlt extends EmailTemplateHDL {
    /**
	 * Email html template path relative to theme root
	 *
	 * @var string
	 */
    public $email_template = 'emails/dist/TransactionalNotificationCtaAlt/template';
