<?php
/**
 * TransactionalNotificationCta Email Template component
 *
 * @package joyjet
 */
 ...
 */
class TransactionalNotificationCta extends EmailTemplateHDL {
    /**
	 * Email html template path relative to theme root
	 *
	 * @var string
	 */
    public $email_template = 'emails/dist/TransactionalNotificationCta/template';
