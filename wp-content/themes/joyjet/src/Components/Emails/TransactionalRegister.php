<?php
/**
 * TransactionalRegister Email Template component
 *
 * @package joyjet
 */
 ...
 */
class TransactionalRegister extends EmailTemplateHDL {
    /**
	 * Email html template path relative to theme root
	 *
	 * @var string
	 */
    public $email_template = 'emails/dist/TransactionalRegister/template';
	...
	public function email_props() : array {
		return array(
			'headline'    => __( 'Conta criada com sucesso.', 'joyjet' ),
