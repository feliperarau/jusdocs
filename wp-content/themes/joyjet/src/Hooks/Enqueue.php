...
class Enqueue extends Hook {
	...
	public function admin_assets(): void {
		...
		wp_enqueue_script( 'joyjet-admin-scripts' );
	}
	...
	public function enqueue_template_scripts(): void {
		...
		wp_enqueue_script( 'joyjet-scripts' );
	...
	public static function get_template_name(): string {
		...
		return apply_filters( 'joyjet_template_name', $template_name );
	}
}