    ...
    <div class="form-top mb-3 pb-7">
		...
		echo new Components\FormControls\Input(
            array(
				...
				'required'    => true,
				'label_class' => 'text-12',
				'placeholder' => __( 'Senha', 'joyjet' ),
				'label'       => __( 'Senha', 'joyjet' ),
            )
		);
		?>
            ...
            <div class="forgot-password">
				...
				echo new Components\Buttons\ModalToggler(
                    array(
						...
						'label'        => __( 'Esqueceu a senha?', 'joyjet' ),
    ...
    <div class="form-bottom">
        <div class="mb-6 d-flex align-items-center justify-content-between">
            <a
                ...
                class="text-color-calma-2"><?php esc_html_e( 'ainda não tem cadastro?', 'joyjet' ); ?></a>
            <a href="<?php echo $sign_up_url; ?>" class="btn btn-primary"><?php esc_html_e( 'Cadastrar', 'joyjet' ); ?></a>
        </div>
		...
		echo new Components\Buttons\ModalToggler(
            array(
				'modal_id'     => 'policy',
				'label'        => __( 'Politicas de Privacidade e Termos de Uso', 'joyjet' ),
